...
namespace GoShared {
    ...
    public class ModifLocationManager : BaseLocationManager {
		...
		private bool hasRequestedPermissions = false;
		...
		private void RequestLocationPermissions()
		{
			...
			Permission.RequestUserPermission(CoarseLocationPermission);
		...
		IEnumerator StartGPS (float waitTime) {
			...
			if (useLocationServices)
			{
				...
				{
					Debug.Log("Location permission has not been granted by the user.");
				}
			}
			else
            { //Demo origin
		...
		private IEnumerator StartLocationService()
		{
			...
			// Location service is initialized and enabled, continue with the updates
			while (true)
			{
				// Do whatever you need to with the location data
				GPSLocationCheck();
